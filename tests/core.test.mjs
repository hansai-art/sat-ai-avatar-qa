...
import {questionSchema,validateQuestions,visibleQuestions,isDate} from '../src/lib/schema.mjs';
...
test('有效小節補上章節，衝突時保留章節',()=>{
 assert.equal(parseState('lesson=ch01-03',taxonomy).state.chapter,'ch01');
